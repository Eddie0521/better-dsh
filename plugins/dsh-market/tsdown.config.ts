/**
 * tsdown build for dsh-market: the host-half stub (lib/index.js, ESM node)
 * plus one browser client bundle (lib/client.js, CJS closure factory) that
 * registers with the package-name id `dsh-market` — the client-modules
...
/** The browser client bundle for the plugin id `dsh-market`. */
function clientBundle(): UserConfig {
  return {
    ...
    plugins: [purityGatePlugin(), makeCssPlugin('dsh-market')],
    outputOptions: {
      entryFileNames: 'client.js',
      sourcemapPathTransform: browserSourcePath,
      banner: `window.__ModuleLoader__.load({ id: "dsh-market", factory: (require) => {`,
...
export default [
  {
    ...
    dts: false,
    // clean stays off: the build script removes lib/ wholesale first.
    clean: false,
  },
  clientBundle(),
